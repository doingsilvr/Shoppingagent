...
<style>
    ...
    .step-wrapper {
        display: flex; background: #FFFFFF; padding: 15px 30px;
        border-radius: 20px; border: 1px solid #E2E8F0; gap: 30px;
    ...
    .step-circle {
        ...
        margin-right: 8px; font-size: 13px; font-weight: 700; flex-shrink: 0;
    }
    .step-title { font-size: 15px; font-weight: 700; color: #64748B; }
    .step-desc { 
        font-size: 12px; color: #94A3B8; margin-left: 34px; line-height: 1.3;
    }
    
    /* 활성화된 단계 */
    .step-active .step-circle { background: #1766F9; color: white; }
    .step-active .step-title { color: #1766F9; }
    .step-active .step-desc { color: #334155; font-weight: 500; }
    ...
    .memory-guide-box {
        ...
        padding: 12px; font-size: 13px; color: #64748B; margin-bottom: 15px; line-height: 1.4;
    }
    .memory-item-style {
    ...
    .product-price { color: #1766F9 !important; font-weight: 700; }
