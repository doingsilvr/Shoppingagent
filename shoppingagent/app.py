...
/* 🔴 모든 버튼 빨간색 통일 */
    div.stButton > button {
        background-color: #DC2626 !important; /* 메인 빨강 */
    ...
    div.stButton > button:hover {
        background-color: #B91C1C !important; /* 마우스 올렸을 때 진한 빨강 */
    }
    
    /* 메모리 삭제 버튼(X)은 배경 흰색에 글자만 빨강 */
    div[data-testid="stBlinkContainer"] button {
        background-color: #ffffff !important;
        color: #DC2626 !important; /* 글자 빨강 */
    ...
    div[data-testid="stBlinkContainer"] button:hover {
        background-color: #FEF2F2 !important; /* 마우스 올렸을 때 연한 빨강 배경 */
