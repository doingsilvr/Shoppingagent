...
def ss_init():
    ...
    ss.setdefault("recommended_products", []) # 중복 추천 방지
...
<style>
    ...
    .product-price { color: #2563EB !important; font-weight: 700; margin-bottom: 10px; }
