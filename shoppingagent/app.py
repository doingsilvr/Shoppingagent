...
def generate_personalized_reason(product, mems, name):
    """
    C안: 카드 내부에 들어갈 짧고 간단한 1~2줄 개인화 요약 생성기
    - 1줄: 제품의 대표 강점 (태그 기반)
    - 2줄: 메모리 기반 개인화 문장 (해당될 때만)
    """
    ...
    if "착용감" in tags or "편안함" in tags or "경량" in tags:
        main = "장시간 착용에도 편해요."
    elif "가성비" in tags:
        main = "가격 대비 성능이 뛰어나요."
    elif "음질" in tags:
        ...
        main = "노이즈캔슬링 성능이 뛰어나요."
    elif "배터리" in tags:
        main = "배터리 지속시간이 길어요."
    else:
        main = "균형 잡힌 성능을 갖춘 제품이에요."
    ...
    if "착용감" in mem_text and ("착용감" in tags or "편안함" in tags):
        addon = "말씀하신 착용감 기준과 잘 맞아요!"
    elif "음질" in mem_text and "음질" in tags:
        addon = "음질을 중요하게 생각하신 기준과 잘 맞아요!"
    elif "노이즈캔슬링" in mem_text and "노이즈캔슬링" in tags:
        addon = "원하신 노이즈캔슬링 기준에도 잘 맞아요!"
    elif "가성비" in mem_text and "가성비" in tags:
        addon = "중요하게 말씀하신 가성비 기준과 잘 맞아요!"
